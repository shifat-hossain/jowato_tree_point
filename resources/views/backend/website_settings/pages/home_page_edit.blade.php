		...
		<div class="card">
			...
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group row">
						<label class="col-md-2 col-from-label">{{translate('Tree Fund Image')}}</label>
						<div class="col-md-10">
							<div class="input-group" data-toggle="aizuploader" data-type="image">
					            <div class="input-group-prepend">
					                <div class="input-group-text bg-soft-secondary font-weight-medium">
								...
								<input type="hidden" name="types[]" value="tree_fund_image">
					            <input type="hidden" name="tree_fund_image" class="selected-files" value="{{ get_setting('tree_fund_image') }}">
					        </div>
					         <div class="file-preview box sm">
					        </div>
							<small class="text-muted">{{ translate('100X100 ') }}.png</small>
